...
class ManualBumpingVersusAutobumpingSpecification extends Specification {
    ...
    def 'autobumping #autobumpTag version, preReleaseTag #preReleaseTag, manually bumping #bump version, manual newPreRelease #newPreRelease, manual promoteToRelease #promoteToRelease, forceBump #forceBump (annotated: #annotated)'() {
        ...
        'pre-release' | null              | PRE_RELEASE | false         | false            | false     | false     || '1.2.3-pre.5'
        ...
        'pre-release' | null              | PRE_RELEASE | false         | false            | true      | false     || '1.2.3-pre.5'
        ...
        'pre-release' | null              | PRE_RELEASE | false         | false            | false     | true      || '1.2.3-pre.5'
        ...
        'pre-release' | null              | PRE_RELEASE | false         | false            | true      | true      || '1.2.3-pre.5'
    ...
    def 'autobumping #autobumpTag version, preReleaseTag #preReleaseTag, manually bumping #bump version, manual newPreRelease #newPreRelease, manual promoteToRelease #promoteToRelease, forceBump #forceBump - should fail (annotated: #annotated)'() {
        ...
        'patch'       | null              | PRE_RELEASE | false         | false            | false     | false     || 'You are trying to manually bump a version component with less precedence than the one specified by the commit message. If you are sure you want to do this, use "forceBump".'
        'minor'       | null              | PRE_RELEASE | false         | false            | false     | false     || 'You are trying to manually bump a version component with less precedence than the one specified by the commit message. If you are sure you want to do this, use "forceBump".'
        ...
        'major'       | null              | PRE_RELEASE | false         | false            | false     | false     || 'You are trying to manually bump a version component with less precedence than the one specified by the commit message. If you are sure you want to do this, use "forceBump".'
        ...
        'pre-release' | 'new-pre-release' | PRE_RELEASE | false         | false            | false     | false     || 'Bumping pre-release component while also creating a new pre-release is not supported'
        'patch'       | 'new-pre-release' | PRE_RELEASE | false         | false            | false     | false     || 'You are trying to manually bump a version component with less precedence than the one specified by the commit message. If you are sure you want to do this, use "forceBump".'
        'minor'       | 'new-pre-release' | PRE_RELEASE | false         | false            | false     | false     || 'You are trying to manually bump a version component with less precedence than the one specified by the commit message. If you are sure you want to do this, use "forceBump".'
        ...
        'major'       | 'new-pre-release' | PRE_RELEASE | false         | false            | false     | false     || 'You are trying to manually bump a version component with less precedence than the one specified by the commit message. If you are sure you want to do this, use "forceBump".'
        ...
        'pre-release' | 'promote'         | PRE_RELEASE | false         | false            | false     | false     || 'Bumping any component while also promoting a pre-release is not supported'
        ...
        'patch'       | 'promote'         | PRE_RELEASE | false         | false            | false     | false     || 'You are trying to manually bump a version component with less precedence than the one specified by the commit message. If you are sure you want to do this, use "forceBump".'
        ...
        'minor'       | 'promote'         | PRE_RELEASE | false         | false            | false     | false     || 'You are trying to manually bump a version component with less precedence than the one specified by the commit message. If you are sure you want to do this, use "forceBump".'
        ...
        'major'       | 'promote'         | PRE_RELEASE | false         | false            | false     | false     || 'You are trying to manually bump a version component with less precedence than the one specified by the commit message. If you are sure you want to do this, use "forceBump".'
        ...
        'pre-release' | null              | PRE_RELEASE | true          | false            | false     | false     || 'Bumping pre-release component while also creating a new pre-release is not supported'
        'patch'       | null              | PRE_RELEASE | true          | false            | false     | false     || 'You are trying to manually bump a version component with less precedence than the one specified by the commit message. If you are sure you want to do this, use "forceBump".'
        'minor'       | null              | PRE_RELEASE | true          | false            | false     | false     || 'You are trying to manually bump a version component with less precedence than the one specified by the commit message. If you are sure you want to do this, use "forceBump".'
        ...
        'major'       | null              | PRE_RELEASE | true          | false            | false     | false     || 'You are trying to manually bump a version component with less precedence than the one specified by the commit message. If you are sure you want to do this, use "forceBump".'
        ...
        'pre-release' | 'new-pre-release' | PRE_RELEASE | true          | false            | false     | false     || 'Bumping pre-release component while also creating a new pre-release is not supported'
        'patch'       | 'new-pre-release' | PRE_RELEASE | true          | false            | false     | false     || 'You are trying to manually bump a version component with less precedence than the one specified by the commit message. If you are sure you want to do this, use "forceBump".'
        'minor'       | 'new-pre-release' | PRE_RELEASE | true          | false            | false     | false     || 'You are trying to manually bump a version component with less precedence than the one specified by the commit message. If you are sure you want to do this, use "forceBump".'
        ...
        'major'       | 'new-pre-release' | PRE_RELEASE | true          | false            | false     | false     || 'You are trying to manually bump a version component with less precedence than the one specified by the commit message. If you are sure you want to do this, use "forceBump".'
        ...
        'pre-release' | 'promote'         | PRE_RELEASE | true          | false            | false     | false     || 'Creating a new pre-release while also promoting a pre-release is not supported'
        ...
        'patch'       | 'promote'         | PRE_RELEASE | true          | false            | false     | false     || 'You are trying to manually bump a version component with less precedence than the one specified by the commit message. If you are sure you want to do this, use "forceBump".'
        ...
        'minor'       | 'promote'         | PRE_RELEASE | true          | false            | false     | false     || 'You are trying to manually bump a version component with less precedence than the one specified by the commit message. If you are sure you want to do this, use "forceBump".'
        ...
        'major'       | 'promote'         | PRE_RELEASE | true          | false            | false     | false     || 'You are trying to manually bump a version component with less precedence than the one specified by the commit message. If you are sure you want to do this, use "forceBump".'
        ...
        'pre-release' | null              | PRE_RELEASE | false         | true             | false     | false     || 'Bumping any component while also promoting a pre-release is not supported'
        ...
        'patch'       | null              | PRE_RELEASE | false         | true             | false     | false     || 'You are trying to manually bump a version component with less precedence than the one specified by the commit message. If you are sure you want to do this, use "forceBump".'
        ...
        'minor'       | null              | PRE_RELEASE | false         | true             | false     | false     || 'You are trying to manually bump a version component with less precedence than the one specified by the commit message. If you are sure you want to do this, use "forceBump".'
        ...
        'major'       | null              | PRE_RELEASE | false         | true             | false     | false     || 'You are trying to manually bump a version component with less precedence than the one specified by the commit message. If you are sure you want to do this, use "forceBump".'
        ...
        'pre-release' | 'new-pre-release' | PRE_RELEASE | false         | true             | false     | false     || 'Creating a new pre-release while also promoting a pre-release is not supported'
        ...
        'patch'       | 'new-pre-release' | PRE_RELEASE | false         | true             | false     | false     || 'You are trying to manually bump a version component with less precedence than the one specified by the commit message. If you are sure you want to do this, use "forceBump".'
        ...
        'minor'       | 'new-pre-release' | PRE_RELEASE | false         | true             | false     | false     || 'You are trying to manually bump a version component with less precedence than the one specified by the commit message. If you are sure you want to do this, use "forceBump".'
        ...
        'major'       | 'new-pre-release' | PRE_RELEASE | false         | true             | false     | false     || 'You are trying to manually bump a version component with less precedence than the one specified by the commit message. If you are sure you want to do this, use "forceBump".'
        ...
        'pre-release' | 'promote'         | PRE_RELEASE | false         | true             | false     | false     || 'Bumping any component while also promoting a pre-release is not supported'
        ...
        'patch'       | 'promote'         | PRE_RELEASE | false         | true             | false     | false     || 'You are trying to manually bump a version component with less precedence than the one specified by the commit message. If you are sure you want to do this, use "forceBump".'
        ...
        'minor'       | 'promote'         | PRE_RELEASE | false         | true             | false     | false     || 'You are trying to manually bump a version component with less precedence than the one specified by the commit message. If you are sure you want to do this, use "forceBump".'
        ...
        'major'       | 'promote'         | PRE_RELEASE | false         | true             | false     | false     || 'You are trying to manually bump a version component with less precedence than the one specified by the commit message. If you are sure you want to do this, use "forceBump".'
        ...
        'pre-release' | null              | PRE_RELEASE | true          | true             | false     | false     || 'Creating a new pre-release while also promoting a pre-release is not supported'
        ...
        'patch'       | null              | PRE_RELEASE | true          | true             | false     | false     || 'You are trying to manually bump a version component with less precedence than the one specified by the commit message. If you are sure you want to do this, use "forceBump".'
        ...
        'minor'       | null              | PRE_RELEASE | true          | true             | false     | false     || 'You are trying to manually bump a version component with less precedence than the one specified by the commit message. If you are sure you want to do this, use "forceBump".'
        ...
        'major'       | null              | PRE_RELEASE | true          | true             | false     | false     || 'You are trying to manually bump a version component with less precedence than the one specified by the commit message. If you are sure you want to do this, use "forceBump".'
        ...
        'pre-release' | 'new-pre-release' | PRE_RELEASE | true          | true             | false     | false     || 'Creating a new pre-release while also promoting a pre-release is not supported'
        ...
        'patch'       | 'new-pre-release' | PRE_RELEASE | true          | true             | false     | false     || 'You are trying to manually bump a version component with less precedence than the one specified by the commit message. If you are sure you want to do this, use "forceBump".'
        ...
        'minor'       | 'new-pre-release' | PRE_RELEASE | true          | true             | false     | false     || 'You are trying to manually bump a version component with less precedence than the one specified by the commit message. If you are sure you want to do this, use "forceBump".'
        ...
        'major'       | 'new-pre-release' | PRE_RELEASE | true          | true             | false     | false     || 'You are trying to manually bump a version component with less precedence than the one specified by the commit message. If you are sure you want to do this, use "forceBump".'
        ...
        'pre-release' | 'promote'         | PRE_RELEASE | true          | true             | false     | false     || 'Creating a new pre-release while also promoting a pre-release is not supported'
        ...
        'patch'       | 'promote'         | PRE_RELEASE | true          | true             | false     | false     || 'You are trying to manually bump a version component with less precedence than the one specified by the commit message. If you are sure you want to do this, use "forceBump".'
        ...
        'minor'       | 'promote'         | PRE_RELEASE | true          | true             | false     | false     || 'You are trying to manually bump a version component with less precedence than the one specified by the commit message. If you are sure you want to do this, use "forceBump".'
        ...
        'major'       | 'promote'         | PRE_RELEASE | true          | true             | false     | false     || 'You are trying to manually bump a version component with less precedence than the one specified by the commit message. If you are sure you want to do this, use "forceBump".'
        ...
        'pre-release' | 'new-pre-release' | PRE_RELEASE | false         | false            | true      | false     || 'Bumping pre-release component while also creating a new pre-release is not supported'
        ...
        'pre-release' | 'promote'         | PRE_RELEASE | false         | false            | true      | false     || 'Bumping any component while also promoting a pre-release is not supported'
        ...
        'pre-release' | null              | PRE_RELEASE | true          | false            | true      | false     || 'Bumping pre-release component while also creating a new pre-release is not supported'
        ...
        'pre-release' | 'new-pre-release' | PRE_RELEASE | true          | false            | true      | false     || 'Bumping pre-release component while also creating a new pre-release is not supported'
        ...
        'pre-release' | 'promote'         | PRE_RELEASE | true          | false            | true      | false     || 'Creating a new pre-release while also promoting a pre-release is not supported'
        ...
        'pre-release' | null              | PRE_RELEASE | false         | true             | true      | false     || 'Bumping any component while also promoting a pre-release is not supported'
        ...
        'pre-release' | 'new-pre-release' | PRE_RELEASE | false         | true             | true      | false     || 'Creating a new pre-release while also promoting a pre-release is not supported'
        ...
        'pre-release' | 'promote'         | PRE_RELEASE | false         | true             | true      | false     || 'Bumping any component while also promoting a pre-release is not supported'
        ...
        'pre-release' | null              | PRE_RELEASE | true          | true             | true      | false     || 'Creating a new pre-release while also promoting a pre-release is not supported'
        ...
        'pre-release' | 'new-pre-release' | PRE_RELEASE | true          | true             | true      | false     || 'Creating a new pre-release while also promoting a pre-release is not supported'
        ...
        'pre-release' | 'promote'         | PRE_RELEASE | true          | true             | true      | false     || 'Creating a new pre-release while also promoting a pre-release is not supported'
        ...
        'patch'       | null              | PRE_RELEASE | false         | false            | false     | true      || 'You are trying to manually bump a version component with less precedence than the one specified by the commit message. If you are sure you want to do this, use "forceBump".'
        'minor'       | null              | PRE_RELEASE | false         | false            | false     | true      || 'You are trying to manually bump a version component with less precedence than the one specified by the commit message. If you are sure you want to do this, use "forceBump".'
        ...
        'major'       | null              | PRE_RELEASE | false         | false            | false     | true      || 'You are trying to manually bump a version component with less precedence than the one specified by the commit message. If you are sure you want to do this, use "forceBump".'
        ...
        'pre-release' | 'new-pre-release' | PRE_RELEASE | false         | false            | false     | true      || 'Bumping pre-release component while also creating a new pre-release is not supported'
        'patch'       | 'new-pre-release' | PRE_RELEASE | false         | false            | false     | true      || 'You are trying to manually bump a version component with less precedence than the one specified by the commit message. If you are sure you want to do this, use "forceBump".'
        'minor'       | 'new-pre-release' | PRE_RELEASE | false         | false            | false     | true      || 'You are trying to manually bump a version component with less precedence than the one specified by the commit message. If you are sure you want to do this, use "forceBump".'
        ...
        'major'       | 'new-pre-release' | PRE_RELEASE | false         | false            | false     | true      || 'You are trying to manually bump a version component with less precedence than the one specified by the commit message. If you are sure you want to do this, use "forceBump".'
        ...
        'pre-release' | 'promote'         | PRE_RELEASE | false         | false            | false     | true      || 'Bumping any component while also promoting a pre-release is not supported'
        ...
        'patch'       | 'promote'         | PRE_RELEASE | false         | false            | false     | true      || 'You are trying to manually bump a version component with less precedence than the one specified by the commit message. If you are sure you want to do this, use "forceBump".'
        ...
        'minor'       | 'promote'         | PRE_RELEASE | false         | false            | false     | true      || 'You are trying to manually bump a version component with less precedence than the one specified by the commit message. If you are sure you want to do this, use "forceBump".'
        ...
        'major'       | 'promote'         | PRE_RELEASE | false         | false            | false     | true      || 'You are trying to manually bump a version component with less precedence than the one specified by the commit message. If you are sure you want to do this, use "forceBump".'
        ...
        'pre-release' | null              | PRE_RELEASE | true          | false            | false     | true      || 'Bumping pre-release component while also creating a new pre-release is not supported'
        'patch'       | null              | PRE_RELEASE | true          | false            | false     | true      || 'You are trying to manually bump a version component with less precedence than the one specified by the commit message. If you are sure you want to do this, use "forceBump".'
        'minor'       | null              | PRE_RELEASE | true          | false            | false     | true      || 'You are trying to manually bump a version component with less precedence than the one specified by the commit message. If you are sure you want to do this, use "forceBump".'
        ...
        'major'       | null              | PRE_RELEASE | true          | false            | false     | true      || 'You are trying to manually bump a version component with less precedence than the one specified by the commit message. If you are sure you want to do this, use "forceBump".'
        ...
        'pre-release' | 'new-pre-release' | PRE_RELEASE | true          | false            | false     | true      || 'Bumping pre-release component while also creating a new pre-release is not supported'
        'patch'       | 'new-pre-release' | PRE_RELEASE | true          | false            | false     | true      || 'You are trying to manually bump a version component with less precedence than the one specified by the commit message. If you are sure you want to do this, use "forceBump".'
        'minor'       | 'new-pre-release' | PRE_RELEASE | true          | false            | false     | true      || 'You are trying to manually bump a version component with less precedence than the one specified by the commit message. If you are sure you want to do this, use "forceBump".'
        ...
        'major'       | 'new-pre-release' | PRE_RELEASE | true          | false            | false     | true      || 'You are trying to manually bump a version component with less precedence than the one specified by the commit message. If you are sure you want to do this, use "forceBump".'
        ...
        'pre-release' | 'promote'         | PRE_RELEASE | true          | false            | false     | true      || 'Creating a new pre-release while also promoting a pre-release is not supported'
        ...
        'patch'       | 'promote'         | PRE_RELEASE | true          | false            | false     | true      || 'You are trying to manually bump a version component with less precedence than the one specified by the commit message. If you are sure you want to do this, use "forceBump".'
        ...
        'minor'       | 'promote'         | PRE_RELEASE | true          | false            | false     | true      || 'You are trying to manually bump a version component with less precedence than the one specified by the commit message. If you are sure you want to do this, use "forceBump".'
        ...
        'major'       | 'promote'         | PRE_RELEASE | true          | false            | false     | true      || 'You are trying to manually bump a version component with less precedence than the one specified by the commit message. If you are sure you want to do this, use "forceBump".'
        ...
        'pre-release' | null              | PRE_RELEASE | false         | true             | false     | true      || 'Bumping any component while also promoting a pre-release is not supported'
        ...
        'patch'       | null              | PRE_RELEASE | false         | true             | false     | true      || 'You are trying to manually bump a version component with less precedence than the one specified by the commit message. If you are sure you want to do this, use "forceBump".'
        ...
        'minor'       | null              | PRE_RELEASE | false         | true             | false     | true      || 'You are trying to manually bump a version component with less precedence than the one specified by the commit message. If you are sure you want to do this, use "forceBump".'
        ...
        'major'       | null              | PRE_RELEASE | false         | true             | false     | true      || 'You are trying to manually bump a version component with less precedence than the one specified by the commit message. If you are sure you want to do this, use "forceBump".'
        ...
        'pre-release' | 'new-pre-release' | PRE_RELEASE | false         | true             | false     | true      || 'Creating a new pre-release while also promoting a pre-release is not supported'
        ...
        'patch'       | 'new-pre-release' | PRE_RELEASE | false         | true             | false     | true      || 'You are trying to manually bump a version component with less precedence than the one specified by the commit message. If you are sure you want to do this, use "forceBump".'
        ...
        'minor'       | 'new-pre-release' | PRE_RELEASE | false         | true             | false     | true      || 'You are trying to manually bump a version component with less precedence than the one specified by the commit message. If you are sure you want to do this, use "forceBump".'
        ...
        'major'       | 'new-pre-release' | PRE_RELEASE | false         | true             | false     | true      || 'You are trying to manually bump a version component with less precedence than the one specified by the commit message. If you are sure you want to do this, use "forceBump".'
        ...
        'pre-release' | 'promote'         | PRE_RELEASE | false         | true             | false     | true      || 'Bumping any component while also promoting a pre-release is not supported'
        ...
        'patch'       | 'promote'         | PRE_RELEASE | false         | true             | false     | true      || 'You are trying to manually bump a version component with less precedence than the one specified by the commit message. If you are sure you want to do this, use "forceBump".'
        ...
        'minor'       | 'promote'         | PRE_RELEASE | false         | true             | false     | true      || 'You are trying to manually bump a version component with less precedence than the one specified by the commit message. If you are sure you want to do this, use "forceBump".'
        ...
        'major'       | 'promote'         | PRE_RELEASE | false         | true             | false     | true      || 'You are trying to manually bump a version component with less precedence than the one specified by the commit message. If you are sure you want to do this, use "forceBump".'
        ...
        'pre-release' | null              | PRE_RELEASE | true          | true             | false     | true      || 'Creating a new pre-release while also promoting a pre-release is not supported'
        ...
        'patch'       | null              | PRE_RELEASE | true          | true             | false     | true      || 'You are trying to manually bump a version component with less precedence than the one specified by the commit message. If you are sure you want to do this, use "forceBump".'
        ...
        'minor'       | null              | PRE_RELEASE | true          | true             | false     | true      || 'You are trying to manually bump a version component with less precedence than the one specified by the commit message. If you are sure you want to do this, use "forceBump".'
        ...
        'major'       | null              | PRE_RELEASE | true          | true             | false     | true      || 'You are trying to manually bump a version component with less precedence than the one specified by the commit message. If you are sure you want to do this, use "forceBump".'
        ...
        'pre-release' | 'new-pre-release' | PRE_RELEASE | true          | true             | false     | true      || 'Creating a new pre-release while also promoting a pre-release is not supported'
        ...
        'patch'       | 'new-pre-release' | PRE_RELEASE | true          | true             | false     | true      || 'You are trying to manually bump a version component with less precedence than the one specified by the commit message. If you are sure you want to do this, use "forceBump".'
        ...
        'minor'       | 'new-pre-release' | PRE_RELEASE | true          | true             | false     | true      || 'You are trying to manually bump a version component with less precedence than the one specified by the commit message. If you are sure you want to do this, use "forceBump".'
        ...
        'major'       | 'new-pre-release' | PRE_RELEASE | true          | true             | false     | true      || 'You are trying to manually bump a version component with less precedence than the one specified by the commit message. If you are sure you want to do this, use "forceBump".'
        ...
        'pre-release' | 'promote'         | PRE_RELEASE | true          | true             | false     | true      || 'Creating a new pre-release while also promoting a pre-release is not supported'
        ...
        'patch'       | 'promote'         | PRE_RELEASE | true          | true             | false     | true      || 'You are trying to manually bump a version component with less precedence than the one specified by the commit message. If you are sure you want to do this, use "forceBump".'
        ...
        'minor'       | 'promote'         | PRE_RELEASE | true          | true             | false     | true      || 'You are trying to manually bump a version component with less precedence than the one specified by the commit message. If you are sure you want to do this, use "forceBump".'
        ...
        'major'       | 'promote'         | PRE_RELEASE | true          | true             | false     | true      || 'You are trying to manually bump a version component with less precedence than the one specified by the commit message. If you are sure you want to do this, use "forceBump".'
        ...
        'pre-release' | 'new-pre-release' | PRE_RELEASE | false         | false            | true      | true      || 'Bumping pre-release component while also creating a new pre-release is not supported'
        ...
        'pre-release' | 'promote'         | PRE_RELEASE | false         | false            | true      | true      || 'Bumping any component while also promoting a pre-release is not supported'
        ...
        'pre-release' | null              | PRE_RELEASE | true          | false            | true      | true      || 'Bumping pre-release component while also creating a new pre-release is not supported'
        ...
        'pre-release' | 'new-pre-release' | PRE_RELEASE | true          | false            | true      | true      || 'Bumping pre-release component while also creating a new pre-release is not supported'
        ...
        'pre-release' | 'promote'         | PRE_RELEASE | true          | false            | true      | true      || 'Creating a new pre-release while also promoting a pre-release is not supported'
        ...
        'pre-release' | null              | PRE_RELEASE | false         | true             | true      | true      || 'Bumping any component while also promoting a pre-release is not supported'
        ...
        'pre-release' | 'new-pre-release' | PRE_RELEASE | false         | true             | true      | true      || 'Creating a new pre-release while also promoting a pre-release is not supported'
        ...
        'pre-release' | 'promote'         | PRE_RELEASE | false         | true             | true      | true      || 'Bumping any component while also promoting a pre-release is not supported'
        ...
        'pre-release' | null              | PRE_RELEASE | true          | true             | true      | true      || 'Creating a new pre-release while also promoting a pre-release is not supported'
        ...
        'pre-release' | 'new-pre-release' | PRE_RELEASE | true          | true             | true      | true      || 'Creating a new pre-release while also promoting a pre-release is not supported'
        ...
        'pre-release' | 'promote'         | PRE_RELEASE | true          | true             | true      | true      || 'Creating a new pre-release while also promoting a pre-release is not supported'
